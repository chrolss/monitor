...
# Generated by qmake (2.01a) (Qt 4.8.6) on: fre jul 10 15:22:46 2015
# Project:  monitor.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.6/bin/qmake -o Makefile monitor.pro
#############################################################################
...
SOURCES       = communicate.cpp \
		com.cpp \
		main.cpp moc_communicate.cpp
OBJECTS       = communicate.o \
		com.o \
		main.o \
		moc_communicate.o
...
Makefile: monitor.pro  /usr/local/Trolltech/Qt-4.8.6/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.6/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.6/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.6/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.6/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/monitor1.0.0/ && $(COPY_FILE) --parents communicate.h com.h .tmp/monitor1.0.0/ && $(COPY_FILE) --parents communicate.cpp com.cpp main.cpp .tmp/monitor1.0.0/ && (cd `dirname .tmp/monitor1.0.0` && $(TAR) monitor1.0.0.tar monitor1.0.0 && $(COMPRESS) monitor1.0.0.tar) && $(MOVE) `dirname .tmp/monitor1.0.0`/monitor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/monitor1.0.0
...
moc_communicate.cpp: com.h \
		communicate.h
	/usr/local/Trolltech/Qt-4.8.6/bin/moc $(DEFINES) $(INCPATH) communicate.h -o moc_communicate.cpp
...
com.o: com.cpp com.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o com.o com.cpp

main.o: main.cpp communicate.h \
		com.h
